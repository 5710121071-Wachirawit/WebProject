...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'./libs/lightbox/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'./libs/lightbox/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'./libs/lightbox/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'./libs/lightbox/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'./libs/lightbox/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
					...
					<div id="lightbox-container-image">
						...
						<div id="lightbox-loading">
							<a href="#" id="lightbox-loading-link">
								<img src=".././libs/lightbox/images/lightbox-ico-loading.gif">
							</a>
						</div>
					</div>
				</div>
					...
					<div id="lightbox-container-image-data">
						...
						<div id="lightbox-secNav">
							<a href="#" id="lightbox-secNav-btnClose">
								<img src=".././libs/lightbox/images/lightbox-btn-close.gif">
							</a>
						</div>
					</div>
				</div>
